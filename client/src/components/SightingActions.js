...
function SightingActions({ handleAddSighting, handleDeleteSighting, handleEditSighting, selectedUserSighting }) {
  return (
    <div className="sighting-actions">
      {/* Always show the Add button */}
      <button onClick={handleAddSighting}>Add New Sighting</button>
      {/* Only show Delete and Edit buttons when a sighting is selected */}
      {selectedUserSighting && (
        <div>
          <button onClick={handleDeleteSighting}>Delete</button>
          <button onClick={handleEditSighting}>Edit</button>
        </div>
      )}
    </div>
  );
